<script>
    ...
    import londonBoroughs from '../../../_data/states-albers-10m.json';
    import mmrData from '../../../_data/us-states-data.json';
    ...
    const geojson = feature(londonBoroughs, londonBoroughs.objects.states);
    ...
    // console.log(dataLookup.get("Alabama"));
      ...
      >
        {#if hideTooltip !== true}
          ...
          >
            ...
            {console.log(dataLookup.get(detail.props[mapJoinKey]))}
